...
tradeInput.addEventListener("input", function(event){
...
checkoutBtn.addEventListener("click", function(){
    ...
    if(tradeInput.value === ""){
        tradeWarn.classic.remove("hidden")
    ...
    window.open(`https://wa.me/${phone}?text=${message} TradeLink:${tradeInput.value}`, "blank")
